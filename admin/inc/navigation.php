...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-indigo elevation-4 sidebar-no-expand bg-gradient">
        <!-- Brand Logo -->
        ...
        <span class="brand-text font-weight-light">MyZine</span>
        </a>
        <!-- Sidebar -->
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=magazines" class="nav-link nav-magazines">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=comments" class="nav-link nav-comments">
