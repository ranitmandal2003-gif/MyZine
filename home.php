                    ...
                    <div class="col-auto flex-grow-1">
                        <div class="col-12">
                            ...
                            <div class="w-100 d-flex justify-content-between align-items-top">
                                <span class="text-muted">Category: <?= ucwords(isset($category_arr[$row['category_id']]) ? $category_arr[$row['category_id']] : "") ?></span>
                                <div>
                                    <span class="text-muted mr-2">Created by: <?= isset($user_arr[$row['user_id']]) ? $user_arr[$row['user_id']] : 'N/A' ?></span>
