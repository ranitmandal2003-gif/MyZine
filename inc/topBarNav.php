      ...
      <nav class="main-header navbar navbar-expand navbar-light border border-light border-top-0  border-left-0 border-right-0 navbar-light text-sm bg-primary text-light" id='top-Nav'>
        ...
        <div class="container">
          <a href="./" class="navbar-brand">
            ...
            <span class="brand-text font-weight-light text-light">MyZine</span>
          </a>
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle  <?= isset($page) && $page =='categories' ? "active" : "" ?>">Categories</a>
          ...
          <div class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
            ...
            <form class="form-inline ml-0 ml-md-3" id="search-form">
                <div class="input-group input-group-sm">
                  <input class="form-control form-control-navbar" type="search" placeholder="Search" name="q" value="<?= isset($_GET['q']) ? urldecode($_GET['q']) : "" ?>" aria-label="Search">
